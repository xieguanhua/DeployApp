...
import { fetchUpsertRole } from '@/service/api';
...
<template>
  <ADrawer v-model:open="visible" :title="title" :width="360">
    ...
    <ASpace v-if="isEdit">
      <AButton v-if="canAccess('role:menu-auth')" @click="openMenuAuthModal">{{ $t('page.manage.role.menuAuth') }}</AButton>
      <MenuAuthModal v-model:visible="menuAuthVisible" :role-id="roleId" />
      <AButton v-if="canAccess('role:button-auth')" @click="openButtonAuthModal">
