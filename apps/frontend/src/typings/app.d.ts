    ...
    type Schema = {
      ...
      page: {
        ...
        mall: {
          ...
          orderStatus: string;
          userName: string;
          assignedKeyCode: string;
          createdAt: string;
          paidAt: string;
          alipayPayload: string;
          copied: string;
          copyFailed: string;
          loadProductsFailed: string;
          loadOrdersFailed: string;
          createKeysTitle: string;
          keyCount: string;
          keyPrefix: string;
          createKeys: string;
          createdKeys: string;
          createKeysSuccess: string;
          createKeysFailed: string;
          ...
          notActivated: string;
          productName: string;
          productManageTitle: string;
          productManageDesc: string;
          installPackages: string;
          installPackageCount: string;
          coverImage: string;
          promoImages: string;
          packageName: string;
          packageUrl: string;
