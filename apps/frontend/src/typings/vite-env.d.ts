...
declare namespace Env {
  ...
  interface ImportMeta extends ImportMetaEnv {
    ...
    /** Whether SMS verification code login is enabled */
    readonly VITE_AUTH_SMS_CODE_ENABLED?: CommonType.YesOrNo;
    /** Whether Email verification code login is enabled */
    readonly VITE_AUTH_EMAIL_CODE_ENABLED?: CommonType.YesOrNo;
    /**
     * The home route key
     *
